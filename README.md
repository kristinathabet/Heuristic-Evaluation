...
## Initial Overall Heuristic Evaluation
...
# Heuristic Evalation
#### 1- Visibility of System Status
When something is searched for in the seach bar, the query is not saved, making it difficult for the user to revisit past subtabs on the website. As you type on the search bar, commonly searched options do not pop up, making users question whether or not the website is resonive to their actions. When users move the cursor over different links and tabs, nothing changes at all, also raising questions about the websites responsiveness. I would recommend making tabs and links change colors when the cursor is placed on them, alerting the users that there is more information to be found in that location. I would also add a component on the page that has a moving image or icon. This would confirm the website is on and running to users. (Severity:2)
...
## About 
The New York Housing Services website is where New York residences can find government assistance for housing. These services range from emergency rental assistance, heating and cooling assistance, disaster recover and aid for both renters and owners. Many residents of New York rely on government aided housing services to live safely and stay afloat. My goal is to suggest improvements of the New York State Housing Services Website so users have a more pleasant experinece interacting with its interface. 
![Website of New York Housing Services](NewYorkhousingservices.png)

## Initial Overall Heuristic Evaluation
When first assessing this website, I found the website easy to navigate and understand. The very top of the page has three featured government services, and below follows all the other services with links to complete the steps. On the left size of the website, users can filter their searches to only see aid that is applicable to them (for example: owning vs. renting). There is a search bar where you can type in key words but it is fairly hidden and doesn’t save users query after they type something in. There is no help page available and no where to ask questions if users need assistance. When users click on a specific service and choose to go back to the home page, it can only be done by clicking the back button on the Google server. There is no built in way to return back to a previous page. Overall, this website looks informative and easy to follow, but there are a few changes that will make users feel more supported by this website. 

#### 1- Visibility of System Status
Phrases and words typed into the search bar are not saved after users interact with other areas of the page. When trying to answer a specific question, users usually type in variations of questions until they receive a viable answer. Not saving users query makes the user spend more type retyping their search every time they want to make any adjustments. For each service available, an overview of the service, eligibility, and application are available. When the cursor is placed over these separate tabs, the interface has no response. This can make users believe that the website is not loading correctly or is unresponsive to their actions. I recommend adding an underlined bar or different color text when the cursor is placed over the words. (Severity:2)
#### 2- Match Between System and the Real World
This website does a good job at using words and phrase that are used in the real world. All benefits found through the website are defined and have clear eligibility standards. The website uses words such as “you” to make users feel like the website is there to help them. There is a notes section located at the bottom of each service page that outlines helpful information that did not have a place anywhere else. Users can look back at these notes to avoid commonly made mistakes on applications. The website is all in English and uses everyday jargon as well. This website is successful in matching its system to practices of the real world. (Severity:2)
#### 3- User Control and Freedom
When users navigate to a specific service on the page, they can only navigate back by clicking the back button presented on Google. This website keeps no record of previous actions that were done by users. When typing in the search engine, query’s are not saved, making it difficult for users to revisit an old tab if they had to exit the tab. There is not much user freedom and users actions are not recorded, making the user feel less in control. I recommend that the website keeps track of all phrases users searched, as well as have a “go back” button in case users make a wrong action they wish to reverse. Although this isn’t the most pressing issue, users would have a much smoother experience with these features present. (Severity:2)
#### 4- Consistency and Standards
This website is consistent in its writing style and word choice. Each service is presented in the same exact layout with overview, eligibility, apply, and contact tabs present on the side of the service page. This meets users expected standards and allows users to learn how to navigate the website quickly. One small adjustment I would make is I would make it clear which services have applications and which don’t. Many of the services begin with “learn about…” and only provide information with no application. This should be stated somewhere easily visible so users do not think there is direct assistance they can apply for directly through the site. (Severity:1)
#### 5- Error Prevention
#### 6- Recognition Rather Than Recall
#### 7- Flexibility and Efficiency of Use	
#### 8- Aesthetic and Minimalist Design
